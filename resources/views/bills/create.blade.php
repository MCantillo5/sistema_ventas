                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('bills.create') }}" method="post">
                                ...
                                <div  style="margin-bottom: 1em;">
                                    ...
                                    <input class="form-control" type="text" name="subtotal" id="subtotal" placeholder="Subtotal" value="{{ old('subtotal') }}">
                                    @error('subtotal')
                                ...
                                <div style="margin-bottom: 1em;">
                                    ...
                                    <input class="form-control" type="text" name="total" id="total" placeholder="Total" value="{{ old('total') }}">
                                    @error('total')
                                    <div style="color: red;">{{ $message }}</div>
                                    @enderror
                                </div>
